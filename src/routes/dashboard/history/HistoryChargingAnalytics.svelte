...
<div class="bg-white flex-grow card p-10 flex flex-col gap-10">
    ...
    <div class="flex flex-row justify-between items-center">
        ...
        <div class="flex flex-row gap-3 items-center">
            <span class="font-normal text-[#8B8B8B] text-[12px]">Finaly battery level: <span class="text-[#1E4CDC]">100%</span></span><img class="h-5 w-5" src="/icons/notifications/notificationIcon.svg"/>
        </div>
    </div>
